...
//                        <h3 className="font-bold text-lg">{resource.section}</h3>
//                        <div className="pl-4">
      ...
      <div className="bg-dark-300 p-4">
        <div className="flex justify-between items-center mx-auto gap-3 lg:w-3/4">
          <div>
            <h6 className="font-semibold">Additional Resources</h6>
            <span className="text-sm">
              We have a list of useful resources on campus!
            </span>
          </div>
          <Dialog>
            <DialogTrigger asChild>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription className="hidden lg:block">
                  This session is designed to provide essential insights into
                  key resources and facilities at Concordia University. Click on
                  the items to see more.
                </DialogDescription>
                <DialogDescription className="block lg:hidden">
                  Scroll to see essential insights into key resources and
                  facilities at Concordia University. Click on the items to see
                  more.
                </DialogDescription>
              </DialogHeader>
              <ScrollArea className="min-h-[60vh] max-h-[70vh]">
