export const resources = [
  ...
  },
  {
    ...
    items: [
      {
        description:
          "Webster Library: Quiet study zones, group rooms, and tech-enabled workspaces for students.",
        link: "https://library.concordia.ca/locations/study-spaces.php",
      },
      {
        description:
          "Study Areas outside library: Multiple floors with study corners equipped with seating and power outlets.",
        link: "https://www.concordia.ca/students/success/superb-study-spots-at-concordia.html",
      },
      {
        description:
          "EV Building Lounges: Open lounges for group and individual study.",
